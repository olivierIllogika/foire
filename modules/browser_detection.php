...
function browser_detection( $which_test ) {
	...
	*/
	if ( !$b_repeat )
	{
		...
		the order is important, because opera must be tested first, 
		...
		*/
		...
		$a_browser_types[] = array( 'omniweb', false, 'omni', 'bro' );// mac osx browser, now uses khtml engine

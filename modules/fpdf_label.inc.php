...
/*
modifications: Olivier Martin, juillet 2005
*/
...
class PDF_Label3of9 extends FPDF {
...
*/
  ...
  var $_Avery_Labels = array (
    ...
    '5162'=>array('name'=>'5162', 'paper-size'=>'letter', 'metric'=>'mm', 'marginLeft'=>4,   'marginTop'=>21,  'NX'=>2,  'NY'=>7,  'SpaceX'=>4,  'SpaceY'=>0,  'width'=>101, 'height'=>35,  'font-size'=>8),
  ...
  // Constructor
  function PDF_Label3of9 ($format, $unit='mm', $posX=1, $posY=1) {
    if (is_array($format)) {
      // Custom format
      $Tformat = $format;
    } else {
  ...
  function Add_PDF_Label($texte) {
    ...
    return array($_PosX, $_PosY, $this->_Width, $this->_Height);
  }
...
*/
function Code39($xpos, $ypos, $code, $show_text=false, $baseline=0.5, $height=5){
  ...
  return array(( $xpos - $start_pos ), $height); // width, height

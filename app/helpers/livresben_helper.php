...
class LivresbenHelper extends AppController
{
  ...
  function courrielLivresVendus($email, $bookList, $returnedBooks, $returnedMoney)
  {
    ...
    $body =
    "Vous venez de r�cup�rer $returnedMoney $ de la vente de vos livres.  ".
    "Cette somme correspond au total de vos ventes moins le montant de la commission pr�lev�e.\n\n".
    "Voici le d�tail de vos livres vendus :\n\n".
    $bookList.

    "\n\nMerci d'avoir particip� � cette �dition de la Foire !";

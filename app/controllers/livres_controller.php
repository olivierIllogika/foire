...
*/
        ...
        $this->flash('Livre ajouté','/livres');
      }
  ...
  function supprimer($id)
  {
    ...
    $this->models['evlivre']->logEvent(434, $d['id'], $d['codebar'], "livre supprim�");
    
    if ($this->models['livre']->del($id))
    {
      $this->flash('Livre supprimé', '/livres');
    }
  }
...
//echo '<pre>'.print_r($this->params['data'],true).'</pre>';die();
      ...
      if ($this->params['data'])
      {
        $this->flash('Livre mis à jour','/livres');
...
/*
          if (strlen($valid_isbn) == 9)
          {
            ...
            // sugg�re cette information titre

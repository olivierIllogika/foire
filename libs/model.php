<?php 
//////////////////////////////////////////////////////////////////////////
// + $Id: model.php,v 1.4 2005/09/04 19:15:42 Administrator Exp $
// +------------------------------------------------------------------+ //
 ...
 */
	function save ($data=null, $validate=true) 
	{
		...
		foreach ($this->data as $n=>$v) 
		{
			...
			{
				$fields[] = $n;
				$values[] = (ini_get('magic_quotes_gpc') == 1) ? $this->db->prepare(stripslashes($v)) : $this->db->prepare($v);
			}
		}
